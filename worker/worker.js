...
Twi number words: baako=1, mmienu=2, mmiensa=3, enan=4, anum=5, nsia=6, nson=7, nwotwe=8, nkron=9, du=10, dunum=15, aduonu=20, aduasa=30, aduanan=40, aduonum=50, oha=100, ahanu=200, apem=1000 (compounds add: oha aduonu = 120). Twi "meton" = I sold, "X de me ka" = X owes me. Pidgin "I sell" = I sold, "X dey owe me" = X owes me. In every language, an amount said once for several items is the total, not the price each.
